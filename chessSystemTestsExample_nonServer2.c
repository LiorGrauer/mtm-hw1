...
bool testChessAddGame_maaroof()
{
    ...
    ASSERT_TEST(chessAddGame(sys1, 1, player_1, player_2, FIRST_PLAYER, -50) == CHESS_GAME_ALREADY_EXISTS);
...
bool oneMoreTestJustYouKnowToMakeSureEveryThingWorksFine_maaroof() {
    ...
    //tournament_3
    ASSERT_TEST(chessAddGame(sys1, 3, player_2, player_1, FIRST_PLAYER, 1) == CHESS_GAME_ALREADY_EXISTS);
