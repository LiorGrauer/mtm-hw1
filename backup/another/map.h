...
Map mapCreate(copyMapDataElements copyDataElement,
              ...
              compareMapKeyElements compareKeyElements); //finished
...
* 		done
*/
void mapDestroy(Map map); //finished
...
*/
bool mapContains(Map map, MapKeyElement element); //finished
...
*/
MapResult mapPut(Map map, MapKeyElement keyElement, MapDataElement dataElement); //finished
...
*/
MapDataElement mapGet(Map map, MapKeyElement keyElement); //finished
...
*/
MapResult mapRemove(Map map, MapKeyElement keyElement); // Finished 
...
*/
MapKeyElement mapGetFirst(Map map); // finished, reset iterator if last or no???
...
*/
MapKeyElement mapGetNext(Map map); // finished, reset iterator if last or no???
...
*/
MapResult mapClear(Map map); // finished
